...
exports.seed = function(knex, Promise) {
  ...
  return knex('shrooms').insert([
    { id: 1, owner_id: 1, name: 'Peppy', cap: 6, base: 2, mouth: 14, eyes: 11, eyeballs: 7, eyebrows: 1, flourish: 1, cap_color_1: '#ffffff', cap_color_2: '#ffffff' },
    { id: 2, owner_id: 2, name: 'Zippy', cap: 5, base: 3, mouth: 15, eyes: 11, eyeballs: 9, eyebrows: 10, flourish: 1, cap_color_1: '#531b93', cap_color_2: '#531b93' },
